      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-8 border-b border-white/5">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-xs">
              Honest student reviews, real placement analytics, and zero
              sponsored noise. Helping you navigate to your ideal future.
            </p>
            {/* Social Icons */}
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="p-1.5 hover:text-white hover:bg-white/5 rounded-full transition-all"
              >
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs">
          ...
          <p className="flex items-center gap-1">
            Built for students, by students with{" "}
