      ...
      <section className="border-b border-slate-200 bg-white px-4 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
            UniVerdict brings college search, comparison, reviews, fees, and
            placements into a clean platform that students and parents can
            understand quickly.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-semibold tracking-normal text-slate-950">
            A college platform that feels usable during admission season
          </h2>
          <p className="mt-4 text-sm leading-7 text-slate-600">
            College discovery often becomes a maze of ads, vague rankings, and
            repeated calls. UniVerdict is built as a calmer alternative: search
            clearly, compare honestly, and keep your shortlist organized.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="rounded-[8px] bg-brand-navy p-8 text-white sm:p-10">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">
            Explore verified colleges and compare the signals that matter before
            counselling or applications begin.
          </p>
          <Link
            href="/colleges"
            className="mt-6 inline-flex rounded-[6px] bg-brand-gold px-5 py-2.5 text-sm font-semibold text-white"
          >
            Explore colleges
          </Link>
        </div>
